...
Transfer races remain OPEN because a positive-byte transfer failure,
dynamic-consumer invalidation, and a real Controller timeout are not yet
combined with that pruning window.
