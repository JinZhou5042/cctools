...
|---|---|---|---|
| GC-SCALE | 10k tasks, 100k bindings, churn, storage pressure | FAIL | The normal-scale subcondition passes at `artifacts/grand-challenge-scale-621f2a83a.json`: 10,438 logical tasks, 124,201 bindings, exact oracle, 10,438 attempt-one completions, and drained releases in 1,575.663s. Deterministic churn and storage pressure at this scale remain absent, so the combined row remains FAIL |
