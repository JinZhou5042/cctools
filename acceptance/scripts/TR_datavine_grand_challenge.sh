...
STORAGE_FRONTIER_STRIDE=${DATAVINE_GRAND_STORAGE_FRONTIER_STRIDE:-0}
STORAGE_BUDGET_BYTES=${DATAVINE_GRAND_STORAGE_BUDGET_BYTES:-0}
...
exec python "$ROOT/acceptance/scripts/datavine_grand_challenge.py" \
  ...
  --storage-frontier-stride "$STORAGE_FRONTIER_STRIDE" \
  --storage-budget-bytes "$STORAGE_BUDGET_BYTES" \
