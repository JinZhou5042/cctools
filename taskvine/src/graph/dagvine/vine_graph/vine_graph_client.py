...
"""Python wrapper for the C vine graph API."""
...
class VineGraphClient:
    ...
    def __init__(self, c_taskvine):
        """Create the backing C vine graph."""
    ...
    def get_total_recovery_tasks(self):
        ...
        return vine_graph_capi.vine_graph_get_total_recovery_tasks(self._c_graph)

    def get_completed_recovery_tasks(self):
        """Return the number of completed recovery tasks."""
        return vine_graph_capi.vine_graph_get_completed_recovery_tasks(self._c_graph)
