...
| RECOVERY | Replica-aware repeated minimal recovery from frontier | FAIL | A worker loss followed by active-persistence global loss completes through two ordinary reexecutions, stable logical IDs, physical-prune/request-drain barriers, and zero special TaskVine recovery tasks at `aac966a09a`; minimum rollback and durability-frontier bounds remain absent |
