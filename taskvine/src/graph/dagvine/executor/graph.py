...
class ExecutorGraph:
    ...
    def add_dependency(self, parent_key, child_key):
        ...
        graph_capi.executor_graph_add_dependency(
    ...
    def add_task_input(self, task_key, filename):
        ...
        graph_capi.executor_graph_add_task_input(self._c_graph, task_id, filename)
    ...
    def add_task_output(self, task_key, filename):
        ...
        if task_id is None:
            raise KeyError(f"Task key not found: {task_key}")
        graph_capi.executor_graph_add_task_output(self._c_graph, task_id, filename)

    def execute(self):
        """Execute the graph."""
        graph_capi.executor_graph_execute(self._c_graph)

    def get_makespan_us(self):
        """Return the graph makespan in microseconds."""
        return graph_capi.executor_graph_get_makespan_us(self._c_graph)

    def get_total_recovery_tasks(self):
        """Return the total number of submitted recovery tasks."""
        return graph_capi.executor_graph_get_total_recovery_tasks(self._c_graph)

    def get_completed_recovery_tasks(self):
        """Return the number of completed recovery tasks."""
        return graph_capi.executor_graph_get_completed_recovery_tasks(self._c_graph)

    def delete(self):
        """Delete the backing C graph."""
        graph_capi.executor_graph_delete(self._c_graph)
